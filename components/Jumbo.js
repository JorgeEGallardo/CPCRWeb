            ...
            <div className="container max-w-8xl relative mx-auto">
                <div className="items-center flex flex-wrap">
                    ...
                    <div className="text-gray-300">
                        ...
                        <Link href="/socios"><a className="bg-gradient-to-r shadow-md shadow-red-500/30 hover:shadow-red-500/90 from-red-900 to-red-900 p-3 py-4 mt-4 text-lg rounded"> Se nuestro socio </a></Link> 
                    </div>
                </div>
            </div>
        </div>
